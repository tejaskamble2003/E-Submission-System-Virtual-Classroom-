...
<div class="container" style="max-width: 1200px;">
	<div class="row">
		...
		if ( isset( $_POST[ 'submit' ] ) ) {
			...
			// $sql = "INSERT INTO `studenttable` (`FName`, `LName`, `FaName`, `DOB`, `Addrs`, `Gender`, `PhNo`, `Eid`, `Pass`,`Course`,'photo') VALUES ('$fname','$lname','$faname','$dob','$addrs','$gender','$phno','$email','$pass','$course','$image')";
			...
			// $tmp_name = $_FILES['image']['tmp_name'];
			//    move_uploaded_file($tmp_name,"../uploads/$image");
			//    $insert = mysqli_query($connect, "insert into user (photo) values('$image') ");
					...
					<!-- Profile code -->
					 <!-- <div class="control-group form-group">
						<div class="controls">
						 ...
						 <label>Upload Profile Image: <span style="color: #ff0000;">*</span></label>
						<div id="upload" style="width: 30%">
