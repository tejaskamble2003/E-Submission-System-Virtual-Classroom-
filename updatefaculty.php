		...
		if(isset($_POST['update']))		
			{
				...
				if (mysqli_query($connect, $sql)) {
					...
					<strong>Success!</strong> Teacher Details updated has been deleted.
					</div>";
					} else {
					// below statement will print error
					echo "<br><Strong>Teacher Details Updating Faliure. Try Again</strong><br> Error Details: " . $sql . "<br>" . mysqli_error($connect);
					}
